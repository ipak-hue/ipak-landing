      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', height: '72px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div className="desktop-nav-buttons" style={{ display: 'flex', gap: '12px' }}>
          ...
          <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '8px', background: '#25D366', color: '#FFFFFF', padding: '10px 20px', borderRadius: '999px', fontSize: '13px', fontWeight: 700, textDecoration: 'none', letterSpacing: '0.04em' }}>
